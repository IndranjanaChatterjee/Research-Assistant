...
# Create retrievers
similarity_retriever = vectorstore.as_retriever(search_type="similarity", search_kwargs={"k": 5}) # standard similarity search retriever

multiquery_retriever = MultiQueryRetriever.from_llm(  # creates a multi-query retriever that generates multiple queries to retrieve diverse results
